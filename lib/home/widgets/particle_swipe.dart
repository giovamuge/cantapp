...
class ParticleSwipeDemoState extends State<ParticleSwipeDemo>
  ...
  void initState() {
    ...
    _spriteSheet = SpriteSheet(
      imageProvider:
          AssetImage("images/circle_spritesheet.png", package: MyApp.pkg),
    ...
    _model = ListModel(
      ...
      // TODO: commented because is not required
  ...
  void _performSwipeAction(Song data, GlobalKey key, SwipeAction action) {
